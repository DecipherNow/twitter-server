...
private object SummaryHandler {
  ...
  def render(
    ...
    procInfo: Seq[String]
      ...
      s"""<script type="application/javascript" src="${staticPrefix}/admin/files/js/summary.js"></script>
      <link type="text/css" href="${staticPrefix}/admin/files/css/summary.css" rel="stylesheet">
      ...
      <div id="server-info" data-refresh-uri="${staticPrefix}/admin/servers/index.txt"></div>
      <div id="client-info" data-refresh-uri="${staticPrefix}/admin/clients/index.txt"></div>"""
}
